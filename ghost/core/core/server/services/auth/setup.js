...
async function installTheme(data, api) {
    ...
    if (themeName.toLowerCase() === 'tryghost/masthead') {
        logging.warn('Skipping theme install as Masthead is the default theme.');
        return data;
    }
    ...
    try {
        ...
        //Fallback to Casper/Masthead by doing nothing as the theme setting update is the last step
